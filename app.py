...
st.markdown("""
    ...
    /* --- SOLUCIÓN DE SIMETRÍA TOTAL --- */
    /* Eliminamos el espacio automático de Streamlit entre filas */
    [data-testid="stVerticalBlock"] > div {
        gap: 0px !important;
    }

    /* Forzamos a que tanto el Header como las Filas de Datos tengan el mismo margen inferior exacto */
    .header-cell, .table-cell {
        margin-bottom: 10px !important; 
    }

    /* Alineación de botones para que no ensanchen la fila de datos */
...
# 5. TABLA INTEGRADA (CON MARGEN UNIFICADO)
if st.session_state.filas:
    col_widths = [1.5, 0.6, 0.6, 0.8, 1, 0.8, 0.6, 0.8, 0.6, 0.6, 0.6]
    
    # Encabezado (dentro de un container para que el CSS lo trate igual que a las filas)
    with st.container():
